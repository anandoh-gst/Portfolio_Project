...
const images = {
    "project-1": project1Image,
    "project-2": project2Image,
    "project-3": project3Image,
    "project-4": project4Image,
    "project-5": project5Image,
    "project-6": project6Image,
    "project-7": project7Image,
  };
...
const Project = ({ title }) => {
  ...
  const imageUrl        = images[projectTitle];
